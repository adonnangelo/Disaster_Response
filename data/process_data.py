...
def load_data(messages_filepath, categories_filepath):
    ...
    Args:
    messages_filepath: file path to the csv containing messages
    categories_filepath: file path to the csv containing categories

    Returns: 
    df: dataframe with messages and categories combined
    """
